...
export default function ServicesClientPage({
  ...
  const servicesStory = useStoryblokState(initialStory);

  if (!servicesStory) return <div>Loading...</div>;

  const body = servicesStory.content?.body;
  const bodyBlocks = Array.isArray(body) ? body : [];
  const hasTextImageSections = bodyBlocks.some(
    (b: { component?: string }) => b.component === 'text image section',
  );

  return (
    <StoryblokPage story={servicesStory}>
      {/* Fallback: hardcoded service sections when CMS has no text image sections */}
      {!hasTextImageSections && (
        <Section>
            ...
            >
              ...
              >
                <p>
                  ...
                  escuta e consciência. O modelo da &quot;primeira consulta&quot;
                  é estruturado em dois tempos:
                  <br />
                </p>
            ...
            >
              ...
              >
                <p>
                  ...
                  Nesta sessão, exploramos as principais dinâmicas do mapa natal
                  e as características do gráfico de Human Design, com foco
